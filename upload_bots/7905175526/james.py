...
API_ID = 33475644
API_HASH = "99d0f874584f6d0f1e6328d905eacaeb"
BOT_TOKEN = "8828438055:AAHuuftXXwbGbhBsgzWDIM2llk96uYFyLBc"

# ========== BOTH ADMINS ==========
ADMIN_IDS = [7905175526]

# ========== CHANNEL ==========
LOG_CHANNEL_ID = -1003850908144
CHECK_CHANNELS = [-1004337305081]
JOIN_URLS = ["https://t.me/VegetaBots"]

# ========== LINKS & MEDIA ==========
TERMS_URL = "https://james-xdd.github.io/Terms-And-Conditions/James.html"
...
# ========== SUPPORT CONTACTS ==========
SUPPORT_USERNAME_1 = "Vengetax101"
...
def get_support_buttons():
    buttons = [
        [Button.url("📩 Owner Support ", f"https://t.me/{SUPPORT_USERNAME_1}")],
...
async def send_main_menu(event, uid):
    ...
    msg = (f"{PE_HEART} <b>Welcome to Fresh Vegeta Otp Store!</b>\n\n"
